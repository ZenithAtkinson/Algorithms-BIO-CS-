...
if __name__ == '__main__':
    ...
    #main(312, 1000, .01, 0.02, 2, 9)
    #main(312, 5000, .002, 0.02, 2, 9)
    #main(312, 10000, .001, 0.02, 2, 9)
    #main(312, 50000, .0002, 0.02, 2, 9)
    #main(312, 100000, .0001, 0.02, 2, 9)

    #main(312, 1000, 1, 0.02, 2, 9)
    #main(312, 2000, 1, 0.02, 2, 9)
    #main(312, 3000, 1, 0.02, 2, 9)
    #main(312, 4000, 1, 0.02, 2, 9)
    #main(312, 5000, 1, 0.02, 2, 9)
    main(312, 6000, 1, 0.02, 2, 9)
